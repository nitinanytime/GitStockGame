  ...
  describe('Games Controller Tests', function () {
    ...
    describe('vm.save() as create', function () {
      ...
      beforeEach(function () {
        ...
        sampleGamePostData = new GamesService({
          name: 'Game Name'
        });

        $scope.vm.game = sampleGamePostData;
      });

      it('should send a POST request with the form input values and then locate to new object URL', inject(function (GamesService) {
        // Set POST response
        ...
        expect($state.go).toHaveBeenCalledWith('games.view', {
          gameId: mockGame._id
        });
      }));
    ...
    describe('vm.save() as update', function () {
      beforeEach(function () {
        // Mock Game in $scope
        $scope.vm.game = mockGame;
      });

      it('should update a valid Game', inject(function (GamesService) {
        // Set PUT response
      ...
      it('should set $scope.vm.error if error', inject(function (GamesService) {
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the Game and redirect to Games', function () {
        ...
        expect($state.go).toHaveBeenCalledWith('games.list');
      });

      it('should should not delete the Game and not redirect', function () {
